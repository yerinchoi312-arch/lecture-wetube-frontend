...
import { likedVideos, type Video } from "../../api/video.ts";
    ...
    if (videos.length === 0) {
        return (
            <div
                ...
                <h2 className={"text-xl font-bold mb-2"}>동영상 좋아요 </h2>
    ...
    return (
        <div className={twMerge(["p-4", "sm:p-6"])}>
            <h1
                ...
                <MdVideoLibrary className={"text-primary-main"} /> 좋아요 표시한 동영상
            </h1>
